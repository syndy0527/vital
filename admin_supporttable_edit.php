...
$pdo = connect_to_db();
// SQL実行
$sql = 'SELECT * FROM support_table WHERE id=:id';
...
<body>
    ...
    <form action="admin_supporttable_update.php" method="POST">
        <div class="container-fluid">
                    ...
                    <form>
                        <fieldset disabled class="input-group justify-content-center" style="max-width: 400px;">
                            <div class="input-group justify-content-center">
                                ...
                                <input type="text" class="form-control fs-5 " placeholder="<?= $record["support_id"] ?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                            </div>
                        </fieldset>
                    </form>
                </div>
                    ...
                    <form>
                        <fieldset disabled class="input-group justify-content-center" style="max-width: 400px;">
                            <div class="input-group justify-content-center">
                                ...
                                <input type="text" class="form-control fs-5 " placeholder="<?= $record["support"] ?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                            </div>
                        </fieldset>
                    </form>
                </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col text-center my-5">
                <a class="btn btn-secondary btn-lg fs-5" style="width: 250px;;height:50px" href="admin_supporttable_read.php" role="button">支援者区分変更・追加へ</a>
            </div>
        </div>
    </div>
