...
foreach ($result as $record) {
    $output .= "<tr><td>{$record['belongs_id']}</td><td>{$record['belongs']}</td>
    <td>
        <a href='admin_belongs_edit.php?id={$record["id"]}' class='btn btn-success' role='button'>変更</a>
      </td><tr>";
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <main class="mb-5">
        <form action="admin_belongs_create.php" method="POST">
            <div class="container-fluid">
                <div class="row justify-content-center  g-2">
                    <p class="h2 text-center my-5">所属区分テーブル追加・変更</p>
                    ...
                    <div class="row justify-content-center  g-2">
                        <div class="input-group mb-3 justify-content-center" style="max-width: 400px;">
                            <span class="input-group-text fs-5" id="inputGroup-sizing-default">所属区分</span>
