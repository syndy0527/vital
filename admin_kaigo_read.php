...
foreach ($result as $record) {
    $output .= "<tr><td>{$record['kaigonintei_id']}</td><td>{$record['kaigonintei']}</td>
    <td>
        <a href='admin_kaigo_edit.php?id={$record["id"]}' class='btn btn-success' role='button'>変更</a>
      </td><tr>";
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <main class="mb-5">
        <form action="admin_kaigo_create.php" method="POST">
            <div class="container-fluid">
                <div class="row justify-content-center  g-2">
                    <p class="h2 text-center my-5">介護認定区分テーブル追加・変更</p>
